"""
MCPNext UI Integration

Integrates the UI system with MCPNext core components.
...
from mcpnext.utils.ui import MCPNextUI, AgentStatus
...
class UIIntegration:
    """
    UI Integration for MCPNext
    
    Connects MCPNext components with the UI system to provide real-time
    visualization of agent activities and execution flow.
    """
    
    def __init__(self, ui: MCPNextUI):
        """
        Initialize UI integration
        
        Args:
            ui: MCPNextUI instance
        """
        self.ui = ui
...
def create_integration(ui: MCPNextUI) -> UIIntegration:
    """
