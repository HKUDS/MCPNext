"""
MCPNext Terminal UI System

Provides real-time CLI visualization for MCPNext execution flow.
...
from mcpnext.utils.display import Box, BoxStyle, colorize
...
class MCPNextUI:
    ...
    def print_banner(self):
        ...
        # Title
        title = colorize("MCPNext", 'c', bold=True)
...
def create_ui(enable_live: bool = True, compact: bool = False) -> MCPNextUI:
    """
    Create MCPNext UI instance
    
    Args:
        enable_live: Whether to enable live display updates
        compact: Use compact layout for smaller terminals
    """
    return MCPNextUI(enable_live=enable_live, compact=compact)